...
Roo Code còn hỗ trợ người dùng tạo các Modes tùy thuộc vào đặc trưng công việc thông qua các API được cung cấp bởi các nhà phân phối mà người dùng mua.
