...
- **File phải đọc:** Sử dụng công cụ `read_file` để đọc `.roo/rules-manim-video-producer/step1-ingestion.md`.
...
- **File phải đọc:** Đọc `.roo/rules-manim-video-producer/step2-planning.md`.
...
- **File phải đọc:** Đọc `.roo/rules-manim-video-producer/step3-coding.md`.
